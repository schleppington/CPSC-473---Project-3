...
<form action="/modifyacct" method="POST">
    <p>
        <label for="first_name">Change First Name: (currently {{acct[1]}})</label> <br/>
        <input type="text" name="first_name"><br/>
    </p>
    <p>
        <label for="last_name">Change Last Name: (currently {{acct[2]}})</label><br/>
        <input type="text" name="last_name"><br/>
    </p>
    <p>
        <label for="email_address">Change Email Address: (currently {{acct[3]}})</label><br/>
